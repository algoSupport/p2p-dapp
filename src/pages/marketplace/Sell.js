...
const SellPage = () => {
  ...
  const toggleSell = () => setModalSell(!modalSell);
  ...
  return (
    <React.Fragment>
      ...
      <Content>
          ...
          <BlockBetween>
            <BlockHeadContent>
              ...
              <BlockDes className="text-soft">
                <p>Sell Crypto currency safely and securely</p>
              </BlockDes>
            </BlockHeadContent>
            <BlockHeadContent>
                ...
                <div className="toggle-expand-content" style={{ display: sm ? "block" : "none" }}>
                  <ul className="nk-block-tools g-3">
                    ...
                    <li className="nk-block-tools-opt">
                      <a href="/marketplace/Sell" onClick={(e) => onCreateOffer(e)}>
        ...
        <Modal isOpen={modalSell} toggle={toggleSell} modalClassName="zoom">
          <ModalHeader
            toggle={toggleSell}
            close={
              <button className="close" onClick={toggleSell}>
                <Icon name="cross" />
              </button>
            }
          >
          ...
          <ModalBody>
            <p>Selling is not yet available. This is just a preview of the updated UI.</p>
          </ModalBody>
        </Modal>
      </Content>
    </React.Fragment>
